...
# a helper compilation function (here only biomass, B4+)
...
* When power is assumed, the retrospective performance of constant M (p502) outperformes the variable M hypothesis (p5mc).
